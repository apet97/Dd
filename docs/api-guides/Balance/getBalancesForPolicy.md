...
### Code examples
```bash
curl -X GET "https://developer.clockify.me/v1/workspaces/{workspaceId}/time-off/balance/policy/{policyId}" \
...
- Artifact: `scripts/api-docs-runner/artifacts/getBalancesForPolicy-200.json`
```json
{
  "balances": [
    {
