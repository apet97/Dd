...
- `attendanceFilter` (ref: #/components/schemas/AttendanceFilterV1, required) 
...
### Code examples
```bash
curl -X POST "https://developer.clockify.me/v1/workspaces/{workspaceId}/reports/attendance" \
...
const response = await fetch('https://developer.clockify.me/v1/workspaces/{workspaceId}/reports/attendance', {
  method: 'POST',
  headers: {
...
url = 'https://developer.clockify.me/v1/workspaces/{workspaceId}/reports/attendance'
headers = {
...
- Artifact: `scripts/api-docs-runner/artifacts/generateAttendanceReport-200.json`
```json
{
  "entities": [
    {
