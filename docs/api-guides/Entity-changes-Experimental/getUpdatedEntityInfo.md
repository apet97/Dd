...
### Code examples
```bash
curl -X GET "https://developer.clockify.me/v1/workspaces/{workspaceId}/entities/updated" \
...
const response = await fetch('https://developer.clockify.me/v1/workspaces/{workspaceId}/entities/updated', {
  method: 'GET',
  headers: {
...
url = 'https://developer.clockify.me/v1/workspaces/{workspaceId}/entities/updated'
headers = {
...
- Artifact: `scripts/api-docs-runner/artifacts/getUpdatedEntityInfo-200.json`
```json
[
  "string"
]
