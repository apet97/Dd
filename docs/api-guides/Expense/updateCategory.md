...
### Code examples
```bash
curl -X PUT "https://developer.clockify.me/v1/workspaces/{workspaceId}/expenses/categories/{categoryId}" \
...
- Artifact: `scripts/api-docs-runner/artifacts/updateCategory-200.json`
```json
{
  "archived": false,
  "hasUnitPrice": false,
