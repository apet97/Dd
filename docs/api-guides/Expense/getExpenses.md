...
| `user-id` | query | string | No |  | If provided, you'll get a filtered list of expenses which match the provided string in the user ID linked to the expense. |
...
### Code examples
```bash
curl -X GET "https://developer.clockify.me/v1/workspaces/{workspaceId}/expenses" \
...
- Artifact: `scripts/api-docs-runner/artifacts/getExpenses-200.json`
```json
{
  "dailyTotals": [
    {
