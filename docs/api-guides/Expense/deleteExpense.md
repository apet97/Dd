...
### Code examples
```bash
curl -X DELETE "https://developer.clockify.me/v1/workspaces/{workspaceId}/expenses/{expenseId}" \
...
- Artifact: `scripts/api-docs-runner/artifacts/deleteExpense-200.json`
