...
### Code examples
```bash
curl -X POST "https://developer.clockify.me/v1/workspaces/{workspaceId}/invoices/{invoiceId}/duplicate" \
...
const response = await fetch('https://developer.clockify.me/v1/workspaces/{workspaceId}/invoices/{invoiceId}/duplicate', {
  method: 'POST',
  headers: {
...
url = 'https://developer.clockify.me/v1/workspaces/{workspaceId}/invoices/{invoiceId}/duplicate'
headers = {
...
- Artifact: `scripts/api-docs-runner/artifacts/duplicateInvoice-201.json`
```json
{
  "amount": 100,
  "balance": 50,
