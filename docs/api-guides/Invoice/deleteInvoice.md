...
### Code examples
```bash
curl -X DELETE "https://developer.clockify.me/v1/workspaces/{workspaceId}/invoices/{invoiceId}" \
...
- Artifact: `scripts/api-docs-runner/artifacts/deleteInvoice-200.json`
