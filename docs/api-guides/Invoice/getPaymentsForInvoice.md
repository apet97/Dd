...
### Code examples
```bash
curl -X GET "https://developer.clockify.me/v1/workspaces/{workspaceId}/invoices/{invoiceId}/payments" \
...
- Artifact: `scripts/api-docs-runner/artifacts/getPaymentsForInvoice-200.json`
```json
[
  {
