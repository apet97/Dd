...
| Name | In | Type | Required | Default | Description |
|------|----|------|----------|---------|-------------|
| `assigned-to` | query | string | No |  | If provided, you'll get a filtered list of holidays assigned to user. |
...
### Code examples
```bash
curl -X GET "https://developer.clockify.me/v1/workspaces/{workspaceId}/holidays" \
...
- Artifact: `scripts/api-docs-runner/artifacts/getHolidays-200.json`
```json
[
  {
