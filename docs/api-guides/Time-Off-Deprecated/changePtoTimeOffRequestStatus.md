## PATCH /v1/workspaces/{workspaceId}/policies/{policyId}/requests/{requestId}
...
### Code examples
```bash
curl -X PATCH "https://developer.clockify.me/v1/workspaces/{workspaceId}/policies/{policyId}/requests/{requestId}" \
...
- Artifact: `scripts/api-docs-runner/artifacts/changePtoTimeOffRequestStatus-200.json`
```json
{
  "balanceDiff": 1,
