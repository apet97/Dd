## POST /v1/workspaces/{workspaceId}/policies/{policyId}/requests
...
### Code examples
```bash
curl -X POST "https://developer.clockify.me/v1/workspaces/{workspaceId}/policies/{policyId}/requests" \
...
const response = await fetch('https://developer.clockify.me/v1/workspaces/{workspaceId}/policies/{policyId}/requests', {
  method: 'POST',
  headers: {
...
url = 'https://developer.clockify.me/v1/workspaces/{workspaceId}/policies/{policyId}/requests'
headers = {
...
- Artifact: `scripts/api-docs-runner/artifacts/createPtoTimeOffRequest-200.json`
```json
{
  "balance": 1,
  "balanceDiff": 1,
