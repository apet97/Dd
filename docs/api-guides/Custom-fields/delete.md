...
### Code examples
```bash
curl -X DELETE "https://developer.clockify.me/v1/workspaces/{workspaceId}/custom-fields/{customFieldId}" \
...
- Artifact: `scripts/api-docs-runner/artifacts/delete-204.json`
