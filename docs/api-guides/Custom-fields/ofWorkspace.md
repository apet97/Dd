...
| Name | In | Type | Required | Default | Description |
|------|----|------|----------|---------|-------------|
| `name` | query | string | No |  | If provided, you'll get a filtered list of custom fields that contain the provided string in their name. |
...
### Code examples
```bash
curl -X GET "https://developer.clockify.me/v1/workspaces/{workspaceId}/custom-fields" \
...
- Artifact: `scripts/api-docs-runner/artifacts/ofWorkspace-200.json`
```json
[
  {
