## DELETE /v1/workspaces/{workspaceId}/policies/{id}
...
### Code examples
```bash
curl -X DELETE "https://developer.clockify.me/v1/workspaces/{workspaceId}/policies/{id}" \
...
- Artifact: `scripts/api-docs-runner/artifacts/deletePtoPolicy-200.json`
