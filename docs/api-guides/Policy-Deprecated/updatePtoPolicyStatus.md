## PATCH /v1/workspaces/{workspaceId}/policies/{id}
...
### Code examples
```bash
curl -X PATCH "https://developer.clockify.me/v1/workspaces/{workspaceId}/policies/{id}" \
...
- Artifact: `scripts/api-docs-runner/artifacts/updatePtoPolicyStatus-200.json`
```json
{
  "allowHalfDay": false,
