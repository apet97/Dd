...
### Code examples
```bash
curl -X DELETE "https://developer.clockify.me/v1/workspaces/{workspaceId}/time-off/policies/{policyId}/requests/{requestId}" \
...
- Artifact: `scripts/api-docs-runner/artifacts/deleteTimeOffRequest-200.json`
```json
{
  "balanceDiff": 1,
