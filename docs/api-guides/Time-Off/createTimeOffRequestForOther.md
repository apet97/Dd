...
### Code examples
```bash
curl -X POST "https://developer.clockify.me/v1/workspaces/{workspaceId}/time-off/policies/{policyId}/users/{userId}/requests" \
...
const response = await fetch('https://developer.clockify.me/v1/workspaces/{workspaceId}/time-off/policies/{policyId}/users/{userId}/requests', {
  method: 'POST',
  headers: {
...
url = 'https://developer.clockify.me/v1/workspaces/{workspaceId}/time-off/policies/{policyId}/users/{userId}/requests'
headers = {
...
- Artifact: `scripts/api-docs-runner/artifacts/createTimeOffRequestForOther-200.json`
```json
{
  "balance": 10,
  "balanceDiff": 1,
