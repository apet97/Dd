...
### Code examples
```bash
curl -X GET "https://developer.clockify.me/v1/workspaces/{workspaceId}/scheduling/assignments/projects/totals/{projectId}" \
...
const response = await fetch('https://developer.clockify.me/v1/workspaces/{workspaceId}/scheduling/assignments/projects/totals/{projectId}', {
  method: 'GET',
  headers: {
...
url = 'https://developer.clockify.me/v1/workspaces/{workspaceId}/scheduling/assignments/projects/totals/{projectId}'
headers = {
...
- Artifact: `scripts/api-docs-runner/artifacts/getProjectTotalsForSingleProject-200.json`
```json
{
  "assignments": [
    {
