...
| Name | In | Type | Required | Default | Description |
|------|----|------|----------|---------|-------------|
| `seriesUpdateOption` | query | string | No |  | Represents a series option. |
...
### Code examples
```bash
curl -X DELETE "https://developer.clockify.me/v1/workspaces/{workspaceId}/scheduling/assignments/recurring/{assignmentId}" \
...
- Artifact: `scripts/api-docs-runner/artifacts/deleteRRecurringAssignment-200.json`
```json
[
  {
