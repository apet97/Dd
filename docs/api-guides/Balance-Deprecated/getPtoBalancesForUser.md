## GET /v1/workspaces/{workspaceId}/balance/user/{userId}
...
### Code examples
```bash
curl -X GET "https://developer.clockify.me/v1/workspaces/{workspaceId}/balance/user/{userId}" \
...
const response = await fetch('https://developer.clockify.me/v1/workspaces/{workspaceId}/balance/user/{userId}', {
  method: 'GET',
  headers: {
...
url = 'https://developer.clockify.me/v1/workspaces/{workspaceId}/balance/user/{userId}'
headers = {
...
- Artifact: `scripts/api-docs-runner/artifacts/getPtoBalancesForUser-200.json`
```json
{
  "balances": [
    {
