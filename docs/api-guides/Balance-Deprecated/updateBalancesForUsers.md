## PATCH /v1/workspaces/{workspaceId}/balance/policy/{policyId}
...
### Code examples
```bash
curl -X PATCH "https://developer.clockify.me/v1/workspaces/{workspaceId}/balance/policy/{policyId}" \
...
- Artifact: `scripts/api-docs-runner/artifacts/updateBalancesForUsers-204.json`
