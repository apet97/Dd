# Workspace (Deprecated) API

**Summary:** This endpoint group contains deprecated endpoints from the [Workspace](#tag/Workspace) endpoint group.
...
|--------|------|-----------|
| DELETE | `/v1/workspaces/{workspaceId}/users/{userId}` | [removeMember.md](removeMember.md) |
