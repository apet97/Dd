...
### Code examples
```bash
curl -X DELETE "https://developer.clockify.me/v1/workspaces/{workspaceId}/shared-reports/{id}" \
...
- Artifact: `scripts/api-docs-runner/artifacts/deleteSharedReportV1-204.json`
