...
### Code examples
```bash
curl -X PUT "https://developer.clockify.me/v1/workspaces/{workspaceId}/projects/{projectId}/users/{userId}/hourly-rate" \
...
const response = await fetch('https://developer.clockify.me/v1/workspaces/{workspaceId}/projects/{projectId}/users/{userId}/hourly-rate', {
  method: 'PUT',
  headers: {
...
url = 'https://developer.clockify.me/v1/workspaces/{workspaceId}/projects/{projectId}/users/{userId}/hourly-rate'
headers = {
...
- Artifact: `scripts/api-docs-runner/artifacts/addUsersHourlyRate-200.json`
```json
{
  "archived": false,
  "billable": false,
