...
### Code examples
```bash
curl -X DELETE "https://developer.clockify.me/v1/workspaces/{workspaceId}/projects/{projectId}" \
...
- Artifact: `scripts/api-docs-runner/artifacts/deleteProject-200.json`
```json
{
  "archived": false,
  "billable": false,
