...
### Code examples
```bash
curl -X PUT "https://developer.clockify.me/v1/workspaces/{workspaceId}/projects/{projectId}/users/{userId}/cost-rate" \
...
const response = await fetch('https://developer.clockify.me/v1/workspaces/{workspaceId}/projects/{projectId}/users/{userId}/cost-rate', {
  method: 'PUT',
  headers: {
...
url = 'https://developer.clockify.me/v1/workspaces/{workspaceId}/projects/{projectId}/users/{userId}/cost-rate'
headers = {
...
- Artifact: `scripts/api-docs-runner/artifacts/addUsersCostRate-200.json`
```json
{
  "archived": false,
  "billable": false,
