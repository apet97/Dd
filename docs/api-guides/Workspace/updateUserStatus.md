...
- **Required:** Yes
- **Schema summary:**
- `status` (string, required) Represents membership status.
- **Minimal example:**
```json
{
  "status": "ACTIVE"
...
### Code examples
```bash
curl -X PUT "https://developer.clockify.me/v1/workspaces/{workspaceId}/users/{userId}" \
...
- Artifact: `scripts/api-docs-runner/artifacts/updateUserStatus-200.json`
```json
{
