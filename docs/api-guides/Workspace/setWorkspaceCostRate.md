...
### Code examples
```bash
curl -X PUT "https://developer.clockify.me/v1/workspaces/{workspaceId}/cost-rate" \
...
const response = await fetch('https://developer.clockify.me/v1/workspaces/{workspaceId}/cost-rate', {
  method: 'PUT',
  headers: {
...
url = 'https://developer.clockify.me/v1/workspaces/{workspaceId}/cost-rate'
headers = {
...
- Artifact: `scripts/api-docs-runner/artifacts/setWorkspaceCostRate-200.json`
```json
{
