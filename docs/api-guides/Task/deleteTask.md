...
### Code examples
```bash
curl -X DELETE "https://developer.clockify.me/v1/workspaces/{workspaceId}/projects/{projectId}/tasks/{taskId}" \
...
- Artifact: `scripts/api-docs-runner/artifacts/deleteTask-200.json`
```json
{
  "assigneeId": "string",
  "assigneeIds": [
