...
### Code examples
```bash
curl -X PUT "https://developer.clockify.me/v1/workspaces/{workspaceId}/projects/{projectId}/tasks/{id}/cost-rate" \
...
const response = await fetch('https://developer.clockify.me/v1/workspaces/{workspaceId}/projects/{projectId}/tasks/{id}/cost-rate', {
  method: 'PUT',
  headers: {
...
url = 'https://developer.clockify.me/v1/workspaces/{workspaceId}/projects/{projectId}/tasks/{id}/cost-rate'
headers = {
...
- Artifact: `scripts/api-docs-runner/artifacts/setTaskCostRate-200.json`
```json
{
  "assigneeId": "string",
  "assigneeIds": [
