...
- `detailedFilter` (ref: #/components/schemas/DetailedFilterV1, optional) 
...
- `weeklyFilter` (ref: #/components/schemas/WeeklyFilterV1, required) 
...
### Code examples
```bash
curl -X POST "https://developer.clockify.me/v1/workspaces/{workspaceId}/reports/weekly" \
...
const response = await fetch('https://developer.clockify.me/v1/workspaces/{workspaceId}/reports/weekly', {
  method: 'POST',
  headers: {
...
url = 'https://developer.clockify.me/v1/workspaces/{workspaceId}/reports/weekly'
headers = {
...
- Artifact: `scripts/api-docs-runner/artifacts/generateWeeklyReport-200.json`
```json
{
  "decimalFormat": false,
  "groupOne": [
