...
- `summaryFilter` (ref: #/components/schemas/SummaryFilterV1, required) 
...
### Code examples
```bash
curl -X POST "https://developer.clockify.me/v1/workspaces/{workspaceId}/reports/summary" \
...
const response = await fetch('https://developer.clockify.me/v1/workspaces/{workspaceId}/reports/summary', {
  method: 'POST',
  headers: {
...
url = 'https://developer.clockify.me/v1/workspaces/{workspaceId}/reports/summary'
headers = {
...
- Artifact: `scripts/api-docs-runner/artifacts/generateSummaryReport-200.json`
```json
{
  "chart": [
    {
