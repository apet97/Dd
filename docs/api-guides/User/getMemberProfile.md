...
### Code examples
```bash
curl -X GET "https://developer.clockify.me/v1/workspaces/{workspaceId}/member-profile/{userId}" \
...
- Artifact: `scripts/api-docs-runner/artifacts/getMemberProfile-200.json`
```json
{
