...
### Code examples
```bash
curl -X POST "https://developer.clockify.me/v1/workspaces/{workspaceId}/users/{userId}/roles" \
...
- Artifact: `scripts/api-docs-runner/artifacts/createUserRole-201.json`
```json
[
  {
